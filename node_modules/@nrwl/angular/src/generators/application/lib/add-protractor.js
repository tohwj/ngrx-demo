...
function addProtractor(host, options, e2eProjectRoot) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const { appsDir, standaloneAsDefault } = devkit_1.getWorkspaceLayout(host);
        ...
        devkit_1.moveFilesToNewDirectory(host, devkit_1.joinPathFragments(appsDir, e2eProjectRoot), options.e2eProjectRoot);
    });
}
